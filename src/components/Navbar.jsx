...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    } else if(currentScrollY > lastScrollY) { //user is lost
  ...
  return (
    <div ref={navContainerRef} 
         className='fixed insert-x-0 top-2 z-50 h-16 border-none 
      ...
      <header className='absolute top-1/2 w-full -translate-y-1/2'>
        <nav className='flex size-full items-center justify-between p-4'>
            ...
            <div className='flex h-full items-center'>
                ...
                <button className='ml-10 flex item space-x-0.5' onClick={toggleAudioIndicator}>
